...
<script language="javascript">
	...
	function SetHome(obj,vrl){try{obj.style.behavior='url(#default#homepage)';obj.setHomePage(vrl);}catch(e){if(window.netscape) {try {netscape.security.PrivilegeManager.enablePrivilege("UniversalXPConnect");}catch (e) {alert("此操作被浏览器拒绝！\n请在浏览器地址栏输入“about:config”并回车\n然后将 [signed.applets.codebase_principal_support]的值设置为'true',双击即可。");}var prefs = Components.classes['@mozilla.org/preferences-service;1'].getService(Components.interfaces.nsIPrefBranch);prefs.setCharPref('browser.startup.homepage',vrl);}}}
		...
		<div class="banner02"><img src="/dongshengsan/Code/Public/asset/home/images/banner08.jpg" width="973" height="149" /></div>
	...
	<div class="mainBody">
		<div class="inc_tit">
			...
			<p class="fr"><a href="http://localhost/xadosun">首页</a> &gt; <span class="redf02">业务范围</span></p>
		</div>
		
		
	<div class="mainL03">
			<div class="mtit02">业务范围</div>
			
					

<div class="menuBox">
	
		<?php if(is_array($intorColumn)): foreach($intorColumn as $key=>$inclumn): if(($inclumn["name"] == $clo["name"])): ?><div class="menuBar01"><a href="<?php echo U('contents',array('cid'=>$inclumn['id']));?>"><?php echo ($inclumn['name']); ?></a></div>
		<?php else: ?>
			<div class="menuBar02"><a href="<?php echo U('contents',array('cid'=>$inclumn['id']));?>"><?php echo ($inclumn['name']); ?></a></div><?php endif; endforeach; endif; ?>	
...
<div class="mtit01">
	<h1>行业资讯</h1>
	<p><a href="<?php echo U('zixundongtai/',array('id'=>37));?>" target="_blank">更多>></a></p>
</div>
<div class="list">
	
	<?php if(is_array($jslist)): foreach($jslist as $key=>$js): ?>·<a href="<?php echo U('zixundongtai/newsDetail',array('id'=>$js['id']));?>" target="_blank">
			<?php
 echo mb_substr($js['title'], 0, 15, 'utf-8' ) ?>	
